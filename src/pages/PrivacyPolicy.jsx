  ...
  return (
    <>
      ...
      <Container maxW={"container.xl"} mb={4} px={0} centerContent>
        <Image
          src={
            "https://forntend-bucket.s3.ap-south-1.amazonaws.com/sose/privcypolicy.jpg"
          }
        />
        <VStack maxW={"6xl"} my={8} px={6}>
          <Box color={"text.300"} textAlign={"justify"}>
            ...
            collect on the Suryan Organic website (<b>www.sose.in</b>) further
            ...
            provided to <b>www.sose.in</b> It does not govern any other information or
            ...
            <br />
            In general, you can visit the <b>www.sose.in</b> without telling us who
